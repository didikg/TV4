...
def create_m3u_playlist(epg_data, group_mapping, country):
    ...
    playlist = f"#EXTM3U url-tvg=\"https://raw.githubusercontent.com/didikg/TV4/refs/heads/main/epg.xml\"\n"
...
def main():
    ...
    for country in countries:
        ...
        save_file(m3u_playlist, "livetv.m3u")
        save_epg_to_file(epg_tree, "tv.xml")
